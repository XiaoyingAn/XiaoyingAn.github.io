...
export class Game {
    ...
    render(ctx) {
        ...
        if (this.paused) {
            ...
            this.ctx.fillText(_("GAME PAUSED"), this.ctx.width / 2, this.ctx.height / 2);
            return;
        };
        ...
        if (this.player.gameover) {
            ...
            this.ctx.fillStyle = "white";
            this.ctx.font = "20px courier new";
            this.ctx.fillText(_("GAME OVER"), this.ctx.width / 2, this.ctx.height / 2);
            this.ctx.font = "16px courier new";
            this.ctx.fillText(_("Press R to restart"), this.ctx.width / 2, this.ctx.height / 2 + 40);
        }
        else {
            ...
            if (this.finished) {
                this.ctx.fillStyle = "white";
                this.ctx.font = "20px courier new";
                this.ctx.fillText(_("CONGRATULATIONS - YOU WIN"), this.ctx.width / 2, this.ctx.height / 2);
                this.ctx.fillText(_("Your score: ") + this.score, this.ctx.width / 2, this.ctx.height / 2 + 40);
            }
        }
    }
